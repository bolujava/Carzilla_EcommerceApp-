package com.decagon.ecommerce.utils;
...
public class CSVUtils {
    ...
    public void readUserCSV(){
        ...
        try(BufferedReader bufferedReader = new BufferedReader(new FileReader("src/main/java/com/decagon/ecommerce/users.csv"))) {
            String line;
        ...
        try(BufferedReader bufferedReader = new BufferedReader(new FileReader("src/main/java/com/decagon/ecommerce/products.csv"))) {
            String line;
            boolean lineOne = false;
            while ((line=bufferedReader.readLine())!=null){
                ...
                if (lineOne) {
                    Product product1 = Product.builder()
                            ...
                            .image(product[3])
                            .quantity(Long.parseLong(product[4]))
                            .build();
